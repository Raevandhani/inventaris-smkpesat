<nav class=" min-h-screen bg-gray-800 border-r border-gray-100 dark:border-gray-700 fixed top-0 left-0 hidden md:block">
    ...
    <div class="py-4">
        <h1 class="text-slate-400 font-bold text-xs px-6 mb-2">MENU</h1>
        <ul>
            <li>
            ...
            <li>
                <x-nav-link :href="route('maintains.index')" :active="request()->routeIs('maintains.index')">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4   ">
    ...
    <div class="bg-slate-700 w-full h-[0.1px] opacity-80"></div>

    <div class="py-4">
        <h1 class="text-slate-400 font-bold text-xs px-6 mb-2">ADMINISTRATION</h1>
        <ul>
            <li>
